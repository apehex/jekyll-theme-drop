...
> If you don't want to use some properties, leave the line blank after the colon `:`
...
To add a custom directory to your theme-gem, please edit the regexp in `jekyll-theme-drop.gemspec` accordingly.
